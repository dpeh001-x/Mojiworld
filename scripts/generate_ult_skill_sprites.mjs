...
const ULT = {
  ...
  // v0.30.52 — Apotheosis v3 is THREE random catastrophe strikes per cast, so
  // the cast burst now shows the three charges being gathered rather than one
  // convergence beam. Radial on purpose: the burst spins 360 deg in-engine.
  elementalist_ult: { p: 'THREE colossal elemental orbs — a blazing orange fire orb, a glacial blue-white ice orb and a crackling yellow-white lightning orb — orbiting a violet-black void singularity at the centre, linked to it by arcs of prismatic energy, all enclosed in a ring of radiant white ascension light. PALETTE: orange, ice-blue, electric yellow, violet and white. No runes, no glyphs, no symbols, no writing of any kind.', m: 'three elemental orbs around a void core — the prismatic arcs linking them shimmer softly in place at one steady rate; no rotation, no flare, core brightness constant.' },
