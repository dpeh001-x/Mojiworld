...
if (content) {
  ...
  add('C. Content', 'C4', 'Bosses have intros, and the finale leads somewhere', S.fixed, 'v0.30.797: intro cards for the eight named bosses that only had a spawn banner (Barnaby, Sundered Smith, Mirror Self, Legosaurus, Master Conductor, Brinekraken, Arbiter, Sovereign) in the game\'s own Everdawn-Cycle lines; all 21 boss arenas resolve a card (dev_surface_and_intro_test 7/7). Closing the credits now names the endgame loops instead of unpausing an empty arena. Mirror Self needs no sprite set: it is drawn from the player\'s own look (_drawMirrorSelf)', 'a real post-game unlock (title, New Game+) is a design call for later');
...
add('D. UI & copy', 'D5', 'Consistent spelling and casing', S.fixed, 'v0.30.798: the seven British spellings in UI labels and toasts are American like the rest of the UI (color, armor, Defense, center); NPC dialogue keeps the spelling it was written in', 'MojiDex / Mojidex and Mojicoins / mojicoins casing is still mixed in a few strings');
