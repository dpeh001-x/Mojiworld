#!/usr/bin/env node
// Gravitos's VOID RIFT: the tear he opens before he teleports, and its nine-frame loop (ludo.ai).
// =============================================================================
// Per user: "gravitos seem to be zipping around the map without warning, make an aura or a pulsation that serves as a
// 1s - 2s hint that he is going to teleport, can create a voidrift VFX as well using ludo.ai".
//
// A vertical tear in space in the fight's own palette (violet, magenta, rose - the three forms' colours), a black void
// inside, a white-hot seam. The game draws it behind Gravitos while he winds up a teleport and at the spot he is about
// to appear, growing as the warning runs out (see _lxGravRiftDraw). Same pipeline and gates as gen_safezone_anim.mjs:
// seated in a 512 sheet with a bold dark outline and a feathered, ink-free border; every loop step must move.
//
...
const PROMPT =
  'game vfx sprite, a VOID RIFT: a tall vertical jagged tear ripped open in space, shaped like a narrow '
  + 'lens or an eye standing upright, filling most of the picture height and about a third of its width. '
  + 'Inside the tear, a deep black void with faint violet stars swirling into it. The torn edges crackle '
  + 'with violet and magenta energy, ragged shards of broken space peeling back along both sides, thin '
  + 'lightning arcs licking outward, a white-hot seam of light running down the centre of the tear, small '
  + 'magenta sparks and dark fragments drifting off the edges. Colours ONLY: deep violet, purple, magenta, '
  + 'hot pink, rose, white-hot highlights, and void black inside. No green, no yellow, no orange, no gold, '
  + 'no cyan, no blue sky. Cel-shaded like a game sprite: a BOLD DARK OUTLINE traces the tear and its shards, '
  + 'crisp contour lines, flat cel shading with hard-edged highlights. Centred, with a clear empty margin all '
  + 'around. Pure transparent background, alpha only: no ground, no floor, no scene, no box, no frame, no '
  + 'square, no border, no character, no text, no letters, no watermark.';
const MOTION =
  'the torn edges of the rift crackle and flicker with violet and magenta energy, the void inside swirls '
  + 'slowly inward, the white-hot seam pulses brighter and dimmer, lightning arcs dance along the edges, '
  + 'sparks and dark fragments drift outward and fade while new ones appear; the rift stays exactly in place '
  + 'and keeps its size and shape; seamless loop, nothing leaves the frame';
