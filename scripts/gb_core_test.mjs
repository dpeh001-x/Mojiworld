...
//   2. THE CORE OUTWEIGHS THE FRAME: 46 against a 15px white and 11px black,
...
try {
  ...
  ok('THE CORE OUTWEIGHS THE FRAME: 46 core, 15 white, 11 black',
    D.size === 46 && D.white === 15 && D.black === 11 && (D.white - D.black) / 2 <= 3,
