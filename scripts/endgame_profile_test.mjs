...
const out = await page.evaluate(() => {
  ...
  return { LV, SP, stars: STARS, baked: _LX_ENDGAME_PROFILES, live };
});
await browser.close();
...
console.log(bad ? `\n${bad} baked value(s) have drifted — update _LX_ENDGAME_PROFILES with the live column` : '\nall good — the baked endgame table matches the live game');
