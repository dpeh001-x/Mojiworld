...
//               v0.30.635 — HD first: the floor is per preset. Low keeps the
...
ok('the governor runs on Medium and Low only; High keeps full resolution (v0.30.635)',
