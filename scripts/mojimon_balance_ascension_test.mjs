...
const r = await page.evaluate(() => {
  ...
  return {
    ...
    trimmedAtkPts,
    capAtk: +(stCap.atk / atk).toFixed(3), capDef: stDef.defRed, CAP: eval('MOJIMON_UPG_PT_CAP'),
...
ok('BALANCE: HP is 6× the player (was 10×)', Math.abs(r.hpMult - 6) < 0.1, { hpMult: r.hpMult });
