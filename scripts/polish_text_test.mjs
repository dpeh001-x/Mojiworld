...
// (portal labels; since v0.30.870 fight toasts use the sign name - see zodiac_sign_names_test).
...
try {
  ...
  const r = await page.evaluate(() => {
    ...
    return {
      ...
      zodiac: gem ? [typeof _lxZodiacShort === 'function' ? _lxZodiacShort(gem) : null, typeof _lxZodiacSign === 'function' ? _lxZodiacSign(gem) : null] : null,
  ...
  check(r.zodiac && r.zodiac[0] === 'Gem & Mini' && r.zodiac[1] === 'Gemini', 'Gemini: portal labels keep "Gem & Mini", fight toasts say "Gemini" (v0.30.870)', J(r.zodiac));
