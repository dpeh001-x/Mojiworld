...
//      maple_game.html — i.e. the keys of the registry.
//   4. Also prints a sample item-definition block per slot so you can
//      copy-paste a quick test item.
//
// The script does not modify maple_game.html — it's a pure printer.
// =============================================================================
...
// Slot list mirrors LX_EQ_REGISTRIES in maple_game.html. Keep in sync if
// new slots are added.
