...
_Generated 2026-05-02 from a four-track audit (bugs, performance, balance, UX) over `maple_game.html` at v0.25.238._
...
### B1 ✅ HIGH · `maple_game.html:17935` — town-respawn skip is dead code
...
### B2 ⚠️ HIGH · `maple_game.html:21129` — `closeAllModals` null-deref on missing modal
