# Skill tabulation — v0.30.1024 (measured)
...
| master | B | War of Banners | warlord_ult | 18812% | 40 | 470% | 60.0 | 88 | 3135 | 5/6 | animTimer | HIGH |
...
| master | G | Warlord's Banner | warlord_warcry | 1136% | 3 | 379% | 25.0 | 63 | 454 | 3/6 | animTimer | LOW |
| master | G | Blade of Calamity | doombringer_apoc | 1760% | 11 | 160% | 18.0 | 75 | 978 | 5/6 | _doomStacks _doomUntil animTimer knockback |  |
| master | G | Divine Aegis | crusader_aegis | 629% | 3 | 210% | 20.0 | 56 | 314 | 2/6 | animTimer | LOW |
| master | G | Sky Lance | dragoon_skylance | 892% | 2 | 446% | 25.0 | 44 | 357 | 2/6 | animTimer knockback stunTimer | LOW |
...
| job | F | Meteor | meteor | 65% | 1 | 65% | 8.0 | 44 | 82 | 1/6 | animTimer | LOW |
...
| job | V | Dark Pulse | darkPulse | 2887% | 72 | 40% | 30.0 | 69 | 962 | 2/6 | animTimer | HIGH |
...
| master | B | Apotheosis | archbishop_ult | 3291% | 6 | 549% | 65.0 | 125 | 506 | 6/6 | animTimer knockback |  |
| master | G | Judgment of the Holy Grail | archbishop_grail | 2531% | 7 | 362% | 30.0 | 75 | 844 | 5/6 | animTimer |  |
...
| master | G | Grand Hex | hexmaster_grandhex | 1485% | 12 | 124% | 25.0 | 44 | 594 | 5/6 | _burnStack _burnTickAcc _dotKind _hexRuptureAt _hexStacks _hexUntil animTimer burnDmg burnTimer freezeTimer knockback |  |
...
| basic | Z | Arrow Shot | arrowShot | 103% | 1 | 103% | 0.8 | 0 | 1284 | 1/6 | animTimer |  |
...
| job | V | Arrow Rain | arrowRain | 677% | 5 | 135% | 10.0 | 53 | 677 | 3/6 | animTimer |  |
| job | V | Elemental Arrows | elementalArrows | 1508% | 10 | 151% | 14.0 | 50 | 1077 | 3/6 | animTimer knockback | HIGH |
| master | B | Deadeye Protocol | marksman_ult | 10613% | 156 | 68% | 60.0 | 81 | 1769 | 1/6 | animTimer | HIGH |
...
| master | B | Eye of the Tempest | skyhunter_ult | 1130% | 13 | 87% | 60.0 | 81 | 188 | 3/6 | _skyMarkUntil animTimer |  |
...
| master | G | Call of the Wild | beastmaster_pack | 1806% | 40 | 45% | 120.0 | 75 | 150 | 2/6 | animTimer |  |
