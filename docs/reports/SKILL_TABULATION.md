# Skill tabulation — v0.30.787 (measured)
...
| master | B | Bastion of Dawn | crusader_ult | 2509% | 3 | 836% | 60.0 | 85 | 418 | 6/6 | animTimer |  |
| master | B | Skyfall Dominion | dragoon_ult | 5383% | 10 | 538% | 50.0 | 78 | 1077 | 6/6 | animTimer | HIGH |
| master | G | Warlord's Banner | warlord_warcry | 1136% | 3 | 379% | 25.0 | 63 | 454 | 3/6 | animTimer knockback |  |
...
| basic | S | Shuriken | throwDagger | 370% | 5 | 74% | 1.3 | 8 | 2842 | 1/6 | animTimer |  |
...
| master | B | Voidwalk | phantom_ult | 2574% | 5 | 515% | 45.0 | 78 | 572 | 6/6 | animTimer knockback |  |
...
| master | G | Voidrift Execution | phantom_cut | 4794% | 7 | 685% | 25.0 | 69 | 1917 | 6/6 | _proxRestUntil _voidBrand animTimer knockback |  |
...
| master | B | Elemental Apotheosis | elementalist_ult | 939% | 2 | 469% | 40.0 | 125 | 235 | 3/6 | animTimer freezeTimer knockback |  |
| master | B | Necrotic Ascendance | necromancer_ult | 1426% | 12 | 119% | 60.0 | 115 | 238 | 4/6 | animTimer |  |
| master | B | Pandemic Hex | hexmaster_ult | 2362% | 13 | 182% | 50.0 | 106 | 472 | 5/6 | _burnStack _burnTickAcc _dotKind _hexStacks _hexUntil animTimer burnDmg burnTimer freezeTimer knockback |  |
| master | B | Apotheosis | archbishop_ult | 3189% | 6 | 531% | 65.0 | 125 | 491 | 6/6 | animTimer knockback | HIGH |
| master | G | Judgment of the Holy Grail | archbishop_grail | 3669% | 7 | 524% | 30.0 | 75 | 1223 | 5/6 | animTimer | HIGH |
...
| master | G | Grand Hex | hexmaster_grandhex | 2266% | 12 | 189% | 25.0 | 44 | 906 | 5/6 | _burnTickAcc _dotKind _hexRuptureAt _hexStacks _hexUntil animTimer burnDmg burnTimer freezeTimer knockback |  |
...
| basic | Z | Arrow Shot | arrowShot | 105% | 1 | 105% | 0.8 | 0 | 1313 | 1/6 | animTimer | LOW |
...
| master | B | Deadeye Protocol | marksman_ult | 4676% | 155 | 30% | 60.0 | 81 | 779 | 1/6 | animTimer | HIGH |
| master | B | War Machine | ballista_ult | 1662% | 11 | 151% | 60.0 | 88 | 277 | 1/6 | animTimer |  |
...
| master | G | Deadeye | marksman_oneshot | 3014% | 81 | 37% | 40.0 | 63 | 753 | 1/6 | animTimer |  |
| master | G | Siege Volley | ballista_volley | 4108% | 106 | 39% | 25.0 | 56 | 1643 | 5/6 | animTimer knockback stunTimer |  |
