...
**marksman_oneshot** · *Deadeye (Focus Fire)* — Deadeye revamp icon, generated by `scripts/gen_deadeye_sfx_icons.mjs`:
> A glowing gold sniper lock-on reticle ring with four tick marks, and four or five bright white-gold tracer lines
> streaking in from the left and converging on its centre, a white-hot impact spark at the bullseye, small cyan sparks.

*Superseded (the pre-revamp One Shot One Kill rail):*
