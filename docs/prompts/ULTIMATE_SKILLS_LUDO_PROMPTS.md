...
**marksman** · *Deadeye Protocol* · `marksman_ult` — Deadeye revamp icon (Overclock), generated by `scripts/gen_deadeye_sfx_icons.mjs`:
> A heavy gold armour-piercing drill bullet wrapped in a spiralling cyan energy helix, bursting through a thin gold
> crosshair ring, with three small glowing homing bullets curving in behind it.

*Superseded (the pre-revamp multi-target reticle):*
