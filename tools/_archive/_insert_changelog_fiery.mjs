...
<p><strong>The Fiery Hideout</strong> — a safe-zone rest stop carved into the basalt beside Sauro Slope. Mid-slope doorway portal (x:1200, between the Lava Cavern and Krook Throne exits) with a return portal home; <code>isTown</code> (no spawns/chests), Lv 40 band, taxi-listable, on the W-map beside the slope&rsquo;s pin, ember-den sky over the slope&rsquo;s basalt backdrop, and the slope&rsquo;s lava ambience. Layout: brew loft, central ember shelf, forge canopy, chimney overlook.</p>
